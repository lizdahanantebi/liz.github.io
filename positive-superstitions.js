define(['pipAPI', 'https://cdn.jsdelivr.net/gh/baranan/minno-tasks@0.3.0/stiat/qualtrics/qstiat6.js'], function(APIConstructor, stiatExtension){
    ...
    return stiatExtension({
        category: {
            ...
            title: { media: { word: 'Positive Superstitions' }, css: { color: '#000000', 'font-size': '2em' }, height: 7 },
            media: [
        ...
        attribute1: {
            name: 'Negative',
            title: { media: { word: 'Negative' }, css: { color: '#000000', 'font-size': '2em' }, height: 7 },
            media: [
                {word: 'awkward'},
                {word: 'hate'},
                {word: 'failure'},
        ...
        attribute2: {
            name: 'Positive',
            title: { media: { word: 'Positive' }, css: { color: '#000000', 'font-size': '2em' }, height: 7 },
            media: [
                {word: 'brilliant'},
                {word: 'diamond'},
                {word: 'joy'},
        ...
        base_url: {
            image: 'https://lizdahanantebi.github.io/images/'
        }
    });
});
