define(['pipAPI', 'https://lizdahanantebi.github.io/liz.github.io/qstiat_negative.js'], function(APIConstructor, stiatExtension){
    ...
    API.addSettings('logger', {
        ...
        onEnd: function(name, settings, ctx){
            ...
            console.log('📊 NEGATIVE test data collected:', csvData);
